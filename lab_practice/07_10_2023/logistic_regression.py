...
def dloss_dw(y_true, y_pred, X):
    ...
    # X.T is the transpose of the input feature matrix 'X'
    # The operator @ represent the matrix multiplication
    # N is the number of examples in the dataset. This step is for computing the average gradient across all examples.
